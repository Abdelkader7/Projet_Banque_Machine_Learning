...
def predict():
    ...
    return render_template('blank.html', pie_chart_data=pie_chart_data, pie_chart_data_missing=pie_chart_data_missing, prediction_text='Sales should be $ {}'.format(1-submission.iloc[0]['TARGET']))
